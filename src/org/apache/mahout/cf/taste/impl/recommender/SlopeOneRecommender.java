...
public final class SlopeOneRecommender extends AbstractRecommender {
  ...
  public List<RecommendedItem> recommend(long userID, int howMany) throws TasteException {
    ...
    List<RecommendedItem> topItems = TopItems.getTopItems(howMany, possibleItemIDs.iterator(), null,
      estimator);
  ...
  @Override
  public int estimatePreference(long userID, long itemID) throws TasteException {
//    DataModel model = getDataModel();
//    Float actualPref = model.getPreferenceValue(userID, itemID);
//    if (actualPref != null) {
//      return actualPref;
//    }
    return On5Util.getValidRating(doEstimatePreference(userID, itemID));
  }
